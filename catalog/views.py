...
def index(request):
    ...
    num_visits = request.session.get('num_visits', 0) #sets num_visits to 0 if not previously existing
...
class AllBorrowedBooksListView(PermissionRequiredMixin, generic.ListView):
    """
    Generic class-based view listing all books that have been borrowed to a librarian
    """
    model = BookInstance
